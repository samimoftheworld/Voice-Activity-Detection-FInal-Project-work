...
sigma=mulmat(siginv,sig) #this will give me a sigma matrix a multiplication of the variances
x=array2d[0]
xu=x-mean
xt=xu.transpose()
sigmainv=inv(sigma)
...
print(len(xu))
print(len(xu[0]))
expval=mulmat(xt,sigmainv) #the expontian value in the fx(x)
expval1=mulmat(expval,xu) #the expontian value in the fx(x)
