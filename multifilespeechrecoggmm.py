#segment multiple file in python (incomplete)
from pydub import AudioSegment
from pydub.silence import split_on_silence
#sound = AudioSegment.from_mp3("my_file.mp3")
k=1
#tifCounter = len(glob.glob1("/home/samim/project-work-in-cdac/audiotrainingset/training","*.wav")) #this will calculate all files in the dicectory i want and of my own formt
...
#testing multiple file by creationg a gmm
...
x = ["" for y in range(23)] #strign array in python
j=1
for i in xrange(91,101):
	x[j]=model.classify('/home/samim/audiotrainingset/testing/n%d.wav'%i)
	j=j+1
for i in xrange(68,79):
	x[j]=model.classify('/home/samim/audiotrainingset/testing/sp%d.wav'%i)
	j=j+1
