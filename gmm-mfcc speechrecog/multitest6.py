...
for i in xrange(1,111):
	x[j],y[j]=model.classify('/home/samim/audiotrainingset/chunktrain/ntestchunk%d.wav'%i)
	j=j+1
for i in xrange(1,66):
	x[j],y[j]=model.classify('/home/samim/audiotrainingset/chunktrain/sptestchunk%d.wav'%i)
	j=j+1
for i in xrange(1,111):
