...
for i in range(1,67): #here i have taken 100 files to be sample
	sound = AudioSegment.from_wav("/home/samim/audiotrainingset/trainingtimit/n-%d.wav"%i) #importing the wan file
	...
	seg.export("/home/samim/audiotrainingset/chunktimit/ntrainchunk%d.wav"%i, format="wav") #export the segment
	seg1.export("/home/samim/audiotrainingset/chunktimit/ntestchunk%d.wav"%i, format="wav") #export the segment
