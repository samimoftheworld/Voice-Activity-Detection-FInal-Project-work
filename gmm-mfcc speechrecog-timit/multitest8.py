...
err1=0
err2=0
x[0],y[0]=model.classify('/home/samim/audiotrainingset/test1.wav')
print 'So the file is calssified as',x[0],'with sp and np frames as ',y[0] ,'sp vs ns  = ',(y[0][0]/(y[0][0]+y[0][1]))
err1=err1+(y[0][0]/(y[0][0]+y[0][1]))
err2=err2+(y[0][1]/(y[0][0]+y[0][1]))

print 'speech vs nonspeech frames ',err1*100,'%'
print 'nonspeech vs speech frames ',err2*100,'%'
