...
def multivar(array2d):
	...
	while (check==1):
		...
		mean=np.random.uniform(5,10,size=(1,13))  #this is mean of the gausiansthe function generates random numbers in a nxm dimention martix in size=(n,m) format for the input matrix
		sig=np.random.uniform(5,10,size=(1,13)) #this is variance sigma ie variance
