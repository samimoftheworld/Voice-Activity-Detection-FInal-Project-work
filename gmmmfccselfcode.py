#a code for gmm creation from mfcc but lots of incorrect methods
import numpy as np
import math
...
def multivar(array2d,mean,sigma): #this functions clacutates the multivariate function of the gmm ie the fxx value
	...
	expo=np.exp(expval1/1000000000000000000) #divided by 10000000000000 just to procede remove later
